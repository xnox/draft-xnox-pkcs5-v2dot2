...
difficulty of attack. Mathematically, an iteration count of c will
increase the security strength of a password by log2(c) bits against
trial-based attacks like brute force or dictionary attacks.
...
might include the following steps:
  ...
  1. Select a salt S and an iteration count c, as outlined in {{salt-count}}.
...
are needed use the derived key as input material to HKDF {{?RFC5869}}.
